...
/// <summary>
/// A <see cref="JsonConverter{Trie2.Node}"/> that minimizes output.
/// The node will be serialized with an extra field, containing the number of children.
/// </summary>
internal sealed class NodeSerializer2 : JsonConverter<Trie2.Node>
{
    #region Fields
    ...
    /// <inheritdoc/>
    public override Trie2.Node Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        throw new NotImplementedException();
    }

    /// <inheritdoc/>
    public override void Write(Utf8JsonWriter writer, Trie2.Node value, JsonSerializerOptions options)
    {
